...
@Injectable()
export class AbhaAddressByAbhaNumberResendOtpService {
  ...
  async getAccessToken() {
    ...
    async PhrResendOtp(transactionId: string) {
      ...
      const response = await axios.post(phrresendOtpURL, verifyData, { headers });
