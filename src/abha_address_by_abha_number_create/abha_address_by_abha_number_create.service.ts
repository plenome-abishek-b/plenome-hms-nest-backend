...
@Injectable()
export class AbhaAddressByAbhaNumberCreateService {
  ...
  async confirmCredentials(password: string, transactionId: string,alreadyExistedPHR: boolean, phrAddress: string) {
