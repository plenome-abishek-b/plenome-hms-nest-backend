...
@Injectable()
export class AbhaAddressByAbhaNumberInitService {
  ...
  async getAccessToken() {
    ...
    async PhrtransactionMethods(authMethod: string,healhtIdNumber: string) {
      ...
      const response = await axios.post(phrtransactionURL, verifyData, { headers });
