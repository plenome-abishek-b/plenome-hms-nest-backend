...
exports.AbhaAddressByAbhaNumberConformCredentialService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("axios");
const crypto = require("crypto");
let AbhaAddressByAbhaNumberConformCredentialService = class AbhaAddressByAbhaNumberConformCredentialService {
    constructor() { }
    ...
    async confirmCredentials(value, transactionId) {
        ...
        const response = await axios_1.default.post(confirmCredentailsURL, verifyData, { headers });
        return response.data;
    }
};
exports.AbhaAddressByAbhaNumberConformCredentialService = AbhaAddressByAbhaNumberConformCredentialService;
exports.AbhaAddressByAbhaNumberConformCredentialService = AbhaAddressByAbhaNumberConformCredentialService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], AbhaAddressByAbhaNumberConformCredentialService);
//# sourceMappingURL=abha_address_by_abha_number_conform_credential.service.js.map