...
exports.AbhaAddressByAbhaNumberCreateService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("axios");
const crypto = require("crypto");
let AbhaAddressByAbhaNumberCreateService = class AbhaAddressByAbhaNumberCreateService {
    constructor() { }
    ...
    async confirmCredentials(password, transactionId, alreadyExistedPHR, phrAddress) {
        ...
        const CreatePhrAddressURL = 'https://phrsbx.abdm.gov.in/api/v1/phr/registration/hid/create-phr-address';
        try {
...
exports.AbhaAddressByAbhaNumberCreateService = AbhaAddressByAbhaNumberCreateService;
exports.AbhaAddressByAbhaNumberCreateService = AbhaAddressByAbhaNumberCreateService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], AbhaAddressByAbhaNumberCreateService);
//# sourceMappingURL=abha_address_by_abha_number_create.service.js.map